...
{{Form::open(array('route' => 'show.store', 'method' => 'post', 'files' => 'true'))}}
...
<div class="row">
	...
	<div class="small-6 columns">
		...
		<input id="datetimepicker_1" type="text" name="start_date" placeholder="Starts At" >
	
	</div>	

	<div class="small-6 columns">
		
		<input id="datetimepicker_2" type="text" name="end_date" placeholder="Ends At" >
	...
	<div class="small-6 columns">
		...
		<label style="color:#ffffff">Banner</label>
